...
public class SpringPizzaApp {
	...
	public static void main(String[] args) throws NoSuchPizzaException {
		...
		ConfigurableApplicationContext appContext = new ClassPathXmlApplicationContext(new String[]{"appContext.xml"}, repositoryContext); // he knows about beans in the parent application context
...
//		System.out.println("Order service class: " + orderService);
//		
//		// 8.04.16
